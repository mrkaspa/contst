				...
				_1: {
					...
					_1: {
						...
						_0: {
							ctor: '_Tuple2',
							_0: 'profile_picture',
							_1: _elm_lang$core$Json_Encode$string(x.profilePicture)
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'bio',
								_1: _elm_lang$core$Json_Encode$string(x.bio)
							},
							_1: {
								ctor: '::',
								_0: {
									ctor: '_Tuple2',
									_0: 'website',
									_1: _elm_lang$core$Json_Encode$string(x.website)
								},
								_1: {
									ctor: '::',
									_0: {
									...
									_1: {
										...
										_0: {
											ctor: '_Tuple2',
											_0: 'is_business',
											_1: _elm_lang$core$Json_Encode$bool(x.isBusiness)
										},
										_1: {ctor: '[]'}
									}
								}
	...
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_0: {
				ctor: '_Tuple2',
				_0: 'media',
				_1: _elm_lang$core$Json_Encode$int(x.media)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'follows',
					_1: _elm_lang$core$Json_Encode$int(x.follows)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'followed_by',
						_1: _elm_lang$core$Json_Encode$int(x.followedBy)
					},
					_1: {ctor: '[]'}
				}
			}
	...
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_0: {
				ctor: '_Tuple2',
				_0: 'id',
				_1: _elm_lang$core$Json_Encode$string(x.id)
			},
			_1: {
				ctor: '::',
				_0: {
...
var _user$project$Auth_Profile$ProfileRequestData = F8(
	function (a, b, c, d, e, f, g, h) {
...
var _user$project$Auth_Profile$profileRequestResponse = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'updated_at',
	_elm_lang$core$Json_Decode$string,
	A3(
...
var _user$project$OAuth_OAuth$errDecoder = A5(
	...
	F4(
		function (error, errorUri, errorDescription, state) {
			return {error: error, errorUri: errorUri, errorDescription: errorDescription, state: state};
		}),
	A2(
		_elm_lang$core$Json_Decode$map,
...
var _user$project$Model$profileEndpoint = function (token) {
	var _p0 = token;
...
var _user$project$Model$CampaignDetail = function (a) {
	return {ctor: 'CampaignDetail', _0: a};
};
var _user$project$Model$Campaigns = {ctor: 'Campaigns'};
...
var _user$project$OAuth_Decode$makeToken = F2(
	function (mtoken, tokenType) {
		var _p0 = {
			ctor: '_Tuple2',
			_0: mtoken,
			_1: _elm_lang$core$String$toLower(tokenType)
		};
...
var _user$project$OAuth_Decode$makeResponseToken = F5(
	function (token, expiresIn, refreshToken, scope, state) {
		return {
			token: token,
			expiresIn: expiresIn,
...
var _user$project$OAuth_Decode$refreshTokenDecoder = A3(
	_elm_lang$core$Json_Decode$map2,
	_user$project$OAuth_Decode$makeToken,
	_elm_lang$core$Json_Decode$maybe(
		A2(_elm_lang$core$Json_Decode$field, 'refresh_token', _elm_lang$core$Json_Decode$string)),
	A2(_elm_lang$core$Json_Decode$field, 'token_type', _elm_lang$core$Json_Decode$string));
var _user$project$OAuth_Decode$accessTokenDecoder = function () {
	var failUnless = function (_p1) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			_elm_lang$core$Json_Decode$fail('can\'t decode token'),
			A2(_elm_lang$core$Maybe$map, _elm_lang$core$Json_Decode$succeed, _p1));
	};
	var mtoken = A3(
		_elm_lang$core$Json_Decode$map2,
		_user$project$OAuth_Decode$makeToken,
		...
		A2(_elm_lang$core$Json_Decode$field, 'token_type', _elm_lang$core$Json_Decode$string));
	return A2(_elm_lang$core$Json_Decode$andThen, failUnless, mtoken);
}();
var _user$project$OAuth_Decode$stateDecoder = _elm_lang$core$Json_Decode$maybe(
	A2(_elm_lang$core$Json_Decode$field, 'state', _elm_lang$core$Json_Decode$string));
var _user$project$OAuth_Decode$lenientScopeDecoder = _elm_lang$core$Json_Decode$maybe(
	A2(
...
var _user$project$OAuth_Decode$scopeDecoder = _elm_lang$core$Json_Decode$maybe(
	A2(
		_elm_lang$core$Json_Decode$field,
		'scope',
		_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$string)));
var _user$project$OAuth_Decode$expiresInDecoder = _elm_lang$core$Json_Decode$maybe(
	A2(_elm_lang$core$Json_Decode$field, 'expires_in', _elm_lang$core$Json_Decode$int));
var _user$project$OAuth_Decode$responseDecoder = A6(_elm_lang$core$Json_Decode$map5, _user$project$OAuth_Decode$makeResponseToken, _user$project$OAuth_Decode$accessTokenDecoder, _user$project$OAuth_Decode$expiresInDecoder, _user$project$OAuth_Decode$refreshTokenDecoder, _user$project$OAuth_Decode$scopeDecoder, _user$project$OAuth_Decode$stateDecoder);
var _user$project$OAuth_Decode$RequestParts = F7(
	function (a, b, c, d, e, f, g) {
		return {method: a, headers: b, url: c, body: d, expect: e, timeout: f, withCredentials: g};
	});
	...
	function (param, xs, qs) {
		...
		if (_p1.ctor === '[]') {
			...
			return A3(
				...
				param,
				A2(_elm_lang$core$String$join, ' ', xs),
				qs);
		}
	});
			...
			function (s) {
				return {
					...
					_0: A2(
						_elm_lang$http$Http$header,
						'Authorization',
						A2(_elm_lang$core$Basics_ops['++'], 'Basic ', s)),
					_1: {ctor: '[]'}
				};
			},
			A2(
					...
					function (_p2) {
						...
						return _truqu$elm_base64$Base64$encode(
							A2(
								_elm_lang$core$Basics_ops['++'],
								_p3.clientId,
								A2(_elm_lang$core$Basics_ops['++'], ':', _p3.secret)));
					},
					credentials))));
};
var _user$project$OAuth_Internal$makeRequest = F4(
	function (adjust, url, headers, body) {
		var requestParts = {
			...
			headers: headers,
			url: url,
			body: A2(_elm_lang$http$Http$stringBody, 'application/x-www-form-urlencoded', body),
			expect: _elm_lang$http$Http$expectJson(_user$project$OAuth_Decode$responseDecoder),
			timeout: _elm_lang$core$Maybe$Nothing,
			withCredentials: false
		};
		return _elm_lang$http$Http$request(
			...
			A3(
				...
				A3(
					...
					A3(
						...
						'redirect_uri',
						_p9.redirectUri,
						A3(_Bogdanp$elm_querystring$QueryString$add, 'client_id', _p9.clientId, _Bogdanp$elm_querystring$QueryString$empty))))));
	return _elm_lang$navigation$Navigation$load(
		A2(_elm_lang$core$Basics_ops['++'], _p9.url, qs));
};

var _user$project$OAuth_Implicit$parse = function (_p0) {
	var _p1 = _p0;
	var qs = _Bogdanp$elm_querystring$QueryString$parse(
		A2(
			_elm_lang$core$Basics_ops['++'],
			'?',
			A2(_elm_lang$core$String$dropLeft, 1, _p1.hash)));
	var gets = A2(
		_elm_lang$core$Basics$flip,
		_Bogdanp$elm_querystring$QueryString$one(_Bogdanp$elm_querystring$QueryString$string),
		qs);
	var geti = A2(
		_elm_lang$core$Basics$flip,
		_Bogdanp$elm_querystring$QueryString$one(_Bogdanp$elm_querystring$QueryString$int),
		qs);
	var _p2 = {
		ctor: '_Tuple2',
		_0: gets('access_token'),
		_1: gets('error')
	};
	_v1_2:
	do {
		if (_p2.ctor === '_Tuple2') {
			if (_p2._0.ctor === 'Just') {
				return A5(
					...
					gets('token_type'),
					geti('expires_in'),
					A2(_Bogdanp$elm_querystring$QueryString$all, 'scope', qs),
					gets('state'));
			} else {
				if (_p2._1.ctor === 'Just') {
					return A4(
...
var _user$project$Utils_Helper$routeParser = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(_evancz$url_parser$UrlParser$map, _user$project$Model$Index, _evancz$url_parser$UrlParser$top),
		_1: {
			ctor: '::',
			_0: A2(
				_evancz$url_parser$UrlParser$map,
				_user$project$Model$Dashboard,
				_evancz$url_parser$UrlParser$s('main')),
			_1: {
				ctor: '::',
				_0: A2(
					_evancz$url_parser$UrlParser$map,
					_user$project$Model$Campaigns,
					_evancz$url_parser$UrlParser$s('campaigns')),
				_1: {
					ctor: '::',
					_0: A2(
						_evancz$url_parser$UrlParser$map,
						_user$project$Model$CampaignDetail,
						A2(
...
var _user$project$Utils_Helper$parseRoute = function (_p1) {
	var _p2 = _p1;
	return A2(_elm_lang$core$String$startsWith, '#access_token', _p2.hash) ? _elm_lang$core$Maybe$Just(_user$project$Model$Index) : A2(_evancz$url_parser$UrlParser$parseHash, _user$project$Utils_Helper$routeParser, _p2);
};
var _user$project$Utils_Helper$getPage = function (location) {
	var _p3 = _user$project$Utils_Helper$parseRoute(location);
	if (_p3.ctor === 'Just') {
		return _p3._0;
	} else {
		return _user$project$Model$NotFound;
	}
};
		...
		if (_p0.ctor === 'Just') {
			...
			var body = _elm_lang$http$Http$jsonBody(
				_user$project$Auth_Profile$encodeProfileRequestData(
					{instagramId: profile.id, username: profile.username, fullName: profile.fullName, profilePicture: profile.profilePicture, bio: profile.bio, website: profile.website, token: _p0._0._0, isBusiness: profile.isBusiness}));
			return A2(
				...
				A3(_elm_lang$http$Http$post, '/api/users', body, _user$project$Auth_Profile$profileRequestResponse));
		} else {
		...
		if (_p0._1.ctor === 'Nothing') {
			if (_p0._0.ctor === 'Nothing') {
						...
						_0: A2(
							_elm_lang$html$Html$button,
							{
								...
								_0: _elm_lang$html$Html_Attributes$style(
									{
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'background', _1: 'url(\'/elm-oauth2/examples/images/google.png\') 1em center no-repeat'},
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'background-size', _1: '2em'},
											_1: {
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 'border', _1: 'none'},
												_1: {
													ctor: '::',
													_0: {ctor: '_Tuple2', _0: 'box-shadow', _1: 'rgba(0,0,0,0.25) 0px 2px 4px 0px'},
													_1: {
														ctor: '::',
														_0: {ctor: '_Tuple2', _0: 'color', _1: '#757575'},
														_1: {
															ctor: '::',
															_0: {ctor: '_Tuple2', _0: 'font', _1: 'Roboto, Arial'},
															_1: {
																ctor: '::',
																...
																_1: {
																	...
																	_1: {
																		ctor: '::',
																		_0: {ctor: '_Tuple2', _0: 'padding', _1: '1em 1em 1em 3em'},
																		_1: {
																			ctor: '::',
				...
				return A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('fetching profile...'),
						_1: {ctor: '[]'}
					});
			}
		} else {
	...
	return A2(
			...
			_0: _elm_lang$html$Html_Attributes$style(
				{
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'padding', _1: '3em'},
								_1: {ctor: '[]'}
							}
						}
					}
		...
		},
		{
			...
			_0: A2(
					...
					_0: _elm_lang$html$Html_Attributes$style(
						{
							...
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'font-family', _1: 'Roboto, Arial, sans-serif'},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'color', _1: '#141414'},
									_1: {ctor: '[]'}
								}
							}
						}),
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('OAuth 2.0 Implicit Flow Example'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
											...
											_1: {
												...
												_1: {
													...
													_1: {
														...
														_1: {
															ctor: '::',
															_0: {ctor: '_Tuple2', _0: 'background', _1: '#e74c3c'},
															_1: {
																ctor: '::',
	...
	},
	{
		...
		subscriptions: function (_p0) {
			return _elm_lang$core$Platform_Sub$batch(
				{
					ctor: '::',
					_0: _user$project$Ports_LocalStorage$storageGetItemResponse(_user$project$Ports_LocalStorage$receiveLocalStorage),
					_1: {ctor: '[]'}
				});
		}
	})();
